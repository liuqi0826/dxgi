...
func (this *DXGIDisplayControl) IsStereoEnabled() bool {
	ret, _, _ := syscall.SyscallN(this.lpVtbl.IsStereoEnabled, uintptr(unsafe.Pointer(this)),
		0,
		0,
	)
...
func (this *DXGIDisplayControl) SetStereoEnabled(enabled bool) error {
	ret, _, _ := syscall.SyscallN(this.lpVtbl.SetStereoEnabled, uintptr(unsafe.Pointer(this)),
